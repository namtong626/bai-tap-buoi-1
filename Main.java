...
class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("--------------------------------------------------------------------------------%n");
        System.out.printf("| %-5s | %-12s | %-12s| %-12s| %-12s | %-13s |%n", "STT", "Ho va ten", "Ngay sinh",
                "So ngay LV", "Gio lam them", "Luong");
        System.out.printf("--------------------------------------------------------------------------------%n");
        System.out.printf("| %-5s | %-12s | %-11s | %-12s| %-12s | %-13s |%n",
        ...
        int tongLuong = luong1 + luong2 + luong3;

        System.out.printf("Tong luong: " + tongLuong);
    }
}
